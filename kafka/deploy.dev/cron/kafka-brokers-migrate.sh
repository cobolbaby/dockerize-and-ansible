...
# 生成执行迁移计划
kafka-reassign-partitions --zookeeper $ZK_HOST --generate --topics-to-move-json-file topics-to-migrate.json --broker-list ?,?,? > topics-to-reassign.json.bak
# 仅保留最后一行
tail -n 1 topics-to-reassign.json.bak > topics-to-reassign.json
# 开始执行
